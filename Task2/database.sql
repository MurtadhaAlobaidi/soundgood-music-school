...
CREATE TABLE "instrument" (
 ...
 "number_in_stock" VARCHAR(500) NOT NULL,
 "id_number" VARCHAR(500) NOT NULL,
 "brand" VARCHAR(500) NOT NULL,
 "monthly_renting_fee" VARCHAR(500) NOT NULL
);
...
ALTER TABLE "parent" ADD CONSTRAINT "PK_parent" PRIMARY KEY ("member_id");
...
ALTER TABLE "student_in_lesson" ADD CONSTRAINT "FK_student_in_lesson_1" FOREIGN KEY ("lesson_id") REFERENCES "lesson" ("lesson_id");
